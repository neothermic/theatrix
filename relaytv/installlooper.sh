...
read ftp_source
echo 'rsync -azvh --delete --progress --exclude=loopScript.sh -e ssh pi@theatrix1.local:/home/content/'$ftp_source'/ ~/theatrix/content' >> ~/theatrix/content/loopScript.sh
